...
type SerializedBlock struct {
	...
	// FYZ
	Method int32 	`protobuf:"bytes,4,opt,name=method,json=method,proto3" json:"method,omitempty"`
	// block additional data, not included in block hash calculation
	AdditionalData *common.AdditionalData `protobuf:"bytes,5,opt,name=additional_data,json=additionalData,proto3" json:"additional_data,omitempty"`
}
