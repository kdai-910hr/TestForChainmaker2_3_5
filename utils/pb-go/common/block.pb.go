...
const (
	// Exectute with DAG
	ScheduleType_DAG MethodType = 1
	// Execute with Spectrum
	ScheduleType_Spectrum MethodType = 2
)
...
type Block struct {
	...
	// FYZ to execute tractions in which way
	Method int32    `protobuf:"bytes,4,opt,name=method,proto3" json:"method,omitempty"`
	// stores the voting information of the current block
	// not included in block hash value calculation
	AdditionalData *AdditionalData `protobuf:"bytes,5,opt,name=additional_data,json=additionalData,proto3" json:"additional_data,omitempty"`
}
